...
const ParentSignUp = () => {
  ...
  const onSubmit = async (credentials) => {
    ...
    try {
      const { data } = await publicFetch.post(`/parent/register`, credentials);

      sessionStorage.setItem("temporaryUserdata", data);
        ...
        <section className="form-section">
          <div className="form-wrapper">
            <div className="form-content">
              <p className="form-login-header"> Parent Registration</p>
